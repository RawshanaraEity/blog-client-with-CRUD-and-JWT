...
//           <div className="md:w-2/3 text-white">
//             <h1 className="mb-5 text-5xl md:text-6xl font-bold">Welcome To InKly.co</h1>
//             <p className="mb-5 text-xl md:text-2xl">We promote positive culture through inspiring articles on health, design, and web.Perfect for magazine, newsletter, professional and personal blog publishing.</p>
